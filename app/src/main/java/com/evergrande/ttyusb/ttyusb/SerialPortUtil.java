...
public class SerialPortUtil {
    ...
    private class SendThread extends Thread{
        ...
        public void run() {
            ...
            for(int i = 0; i < Cmd.TEST_COUNT; i++) {
            ...
            /*结果判断*/
            if(successCount/2 == Cmd.TEST_COUNT) {
        ...
        public void run() {
            ...
            while (isStart == true) {
               ...
               byte[] readData = new byte[1024];
                ...
                try {
                    int size = inputStream1.read(readData1);
                    if (size > 0) {
                        String readString = DataUtils.ByteArrToHex(readData1, 0, size);
                        EventBus.getDefault().post("[0]"+readString);
                        isRecive = true;
